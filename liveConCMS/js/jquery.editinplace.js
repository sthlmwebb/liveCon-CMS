...
$.fn.editInPlace.defaults = {
	...
	save_button:		'', // string: image button tag to use as “Save” button
	cancel_button:		'', // string: image button tag to use as “Cancel” button
	...
	saving_image:		"liveConCMS/skins/images/loading01.gif", // string: uses saving text specify an image location instead of text while server is saving
