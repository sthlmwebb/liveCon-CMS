...
/*// Settings
	//$save_path = getcwd() . "/uploaded/";		// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment) */
	$save_path = $_POST['PHPtest'];
	
	$upload_name = "Filedata";
	$max_file_size_in_bytes = 2147483647;			
	$extension_whitelist = array("jpg", "jpeg", "gif", "png", "ico", "html", "htm", "php", "txt", "doc", "docx", "pdf", "css", "zip", "flv", "mov", "wmv", "mpeg");	/*// Allowed file extensions */
